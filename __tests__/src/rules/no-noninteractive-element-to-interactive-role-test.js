...
import rule
  from '../../../src/rules/no-noninteractive-element-to-interactive-role';
...
const neverValid = [
  ...
  { code: '<input type="hidden" role="button" />', errors: [expectedError] },
  ...
  { code: '<input type="hidden" role="menuitem" />', errors: [expectedError] },
