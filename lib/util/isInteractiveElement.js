...
var interactiveAXObjects = new Set([].concat(_toConsumableArray(_axobjectQuery.AXObjects.keys())).filter(function (name) {
  return ['widget'].includes(_axobjectQuery.AXObjects.get(name).type);
}));

var interactiveElementAXObjects = [].concat(_toConsumableArray(_axobjectQuery.elementAXObjects.entries())).reduce(function (accumulator, _ref5) {
...
function checkIsInteractiveElement(tagName, attributes) {
  ...
  try {
    for (var _iterator = interactiveElementRoles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  try {
    for (var _iterator2 = nonInteractiveElementRoles[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  try {
    for (var _iterator3 = interactiveElementAXObjects[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
